    ...
    .then(
        axios.spread(
            (firstResponse, secondResponse, thirdResponse) => {
                console.log(firstResponse.data[0].url, secondResponse.data[0].url, thirdResponse.data[0].url);
                var img1 = firstResponse.data[0].url
                var img2 = secondResponse.data[0].url
                var img3 = thirdResponse.data[0].url
